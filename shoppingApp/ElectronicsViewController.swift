...
class ElectronicsViewController:
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        // preset a number for this shopping list
 ...
 // number of columns in a picker.
    func pickerView(_ pickerView: UIPickerView, numberOfRowsInComponent component: Int) -> Int {
        return decisionState.count
    }
    // showing "sure", "maybe", "maynot", "future"
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
           return decisionState[row]
       }
    // when save button is pressed, show the message for what are on the list
...
// let selected = elecItem1.text + ","+ elecItem2.text+ ","+ elecItem3.text+ ","+ elecItem4.text+ ","+ elecItem5.text
    ...
    // reset the text and picker value in when reset is pressed
